...
//uint16_t touchScreenMinimumX = 240, touchScreenMaximumX = 3800, touchScreenMinimumY = 200, touchScreenMaximumY = 3700;
...
uint32_t *draw_buf;      //draw_buf is allocated on heap otherwise the static area is too big on ESP32 at compile
...
static void value_changed_event_arc1_cb(lv_event_t *e) {
  ...
  //Update arc2
  lv_arc_set_value(objects.arc1, arc1Value);
  lv_label_set_text_fmt(objects.label_arc1, "%d", arc1Value);
