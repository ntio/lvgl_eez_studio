/*
* Esto supone que ya tienes LVGL funcionando con Arduino/ESP32
- Arduino
- ~/Arduino
- EEZ Studio
- ~/eez-projects

1. Crear la interfaz de usuario con EEZ Studio
- Recuerda configurar el ancho/alto de la pantalla y la profundidad a 16 bits, tal como lo usa ESP32.
- En Archivo > Configuración del proyecto, configura lo siguiente:
- Raíz de exportación del proyecto
- Ruta de exportación de los archivos de la interfaz de usuario (esta contendrá los archivos Deberás copiarlo al proyecto Arduino.
- Recuerda esta ubicación, ya que deberás copiar el contenido.
- Exportar el código de la interfaz de usuario.
- Exportar > Exportar archivos de interfaz de usuario.
- Esto creará los archivos en la ruta de exportación de archivos de interfaz de usuario que creaste anteriormente.
- Crear un nuevo proyecto Arduino.
- Abrir uno existente.
- Copiar todos los archivos de interfaz de usuario a la raíz del proyecto Arduino.
- En la configuración de Arduino (configure()), añade:
- ui_init();
